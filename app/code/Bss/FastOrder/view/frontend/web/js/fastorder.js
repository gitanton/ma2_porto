    ...
    $.widget('bss.fastorder', {
        ...
        _reloadTotalPrice: function (el,fomatPrice) {
            var totalPrice,
                ...
                obj = {},
                // popup = $(el).closest('tr.bss-fastorder-row').find('.bss-fastorder-autocomplete .bss-show-popup').val(),
            ...
            if (qty > 0 && obj != null && obj != 'undefined' && obj != undefined) {
        ...
        _getItemsLocalStorage: function (el, suggestCacheKey, sortOrder) {
            var $widget = this,
                data = JSON.parse($widget.options.suggestCache[suggestCacheKey]),
